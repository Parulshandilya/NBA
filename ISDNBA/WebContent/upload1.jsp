...
<p> <img src="marks(1).png" align="left"><br><br><h4 style="colo: dark grey">Instructions</h4>
<h5 style="color: dark grey" >1.The marks list is to be submitted in excel sheet.<br>
2.All the blank spaces should be filled with zero.<br>
3.The image shown in the left is an example of the marks list.<br>
4.To upload the marks list ,click on upload button.<br>
5.After clicking on upload you will be directed to the next page where you can upload CO/AC.</h5></p>
<br>
<br>
<br>
...
<form action="up1" method="post" enctype="multipart/form-data">
		...
		Select File to  Upload(Marks):<input type="file" name="uploadFile1"/multiple>
