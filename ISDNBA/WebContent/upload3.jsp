...
<br>
<br><br><br>
<p> <img src="cm(1)(1).png" align="left" height="220px" width="760px"><h4 style="colo: dark grey">Instructions</h4>
<h5 style="color: dark grey" >1.The correlation Matrix is to be submitted in excel sheet.<br>
2.All the blank spaces should be filled with 0.<br>
3.The image shown in the left is an example of the Correlation Matrix.<br>
4.To upload Correlation Matrix,click on upload button.<br>
5.After clicking on Finish you will be directed to the next page 
...
<head></head>
<body>
<form action="up3" method="post" enctype="multipart/form-data">
		<h4>Upload</h4>
		</br>
		<!--  <p5>Course Name: </p5>
		...
		Select File to  Upload(COMatrix):<input type="file" name="uploadFile1"/multiple>
